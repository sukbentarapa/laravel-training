...
<body class="index-page">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="{{ route('calculator', [1]) }}">Calculator</a></li>
                        <li><a href="{{ route('salam.index') }}">Salam</a></li>
    ...
    <script src="{{ asset('bizland/vendor/php-email-form/validatex.js') }}"></script>
    ...
    <script src="{{ asset('bizland/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
